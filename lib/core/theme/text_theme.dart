...
import 'package:debug_app_web/core/theme/app_colors.dart';
import 'package:flutter/material.dart';

TextTheme get textTheme => TextTheme(
      displayLarge: AppFonts.displayLarge.copyWith(color: DarkColorsToken.textPrimary),
      displayMedium: AppFonts.displayMedium.copyWith(color: DarkColorsToken.textPrimary),
      displaySmall: AppFonts.displaySmall.copyWith(color: DarkColorsToken.textPrimary),
      headlineLarge: AppFonts.headlineLarge.copyWith(color: DarkColorsToken.textPrimary),
      headlineMedium:
          AppFonts.headlineMedium.copyWith(color: DarkColorsToken.textPrimary),
      headlineSmall: AppFonts.headlineSmall.copyWith(color: DarkColorsToken.textPrimary),
