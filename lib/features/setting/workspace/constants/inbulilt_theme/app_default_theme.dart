...
import 'package:theme_ui_widgets/theme/data/primitive.dart';
...
class AppDefaultTheme implements AppThemeColorSetBuilder {
  @override
  AppThemeColorSet light({String? fontFamily}) {
    ...
    final borderColorScheme = AppBorderColorScheme(
      ...
      errorThickHover: AppPrimitiveTokens.red700,
      featuredThick: AppPrimitiveTokens.purple500,
      featuredThickHover: AppPrimitiveTokens.purple600, disabled: null, focus: null, error: null, success: null, warning: null,
    );
  ...
  @override
  AppThemeColorSet dark({String? fontFamily}) {
    final textColorScheme = AppTextColorScheme(
      primary: AppPrimitiveTokens.neutral200,
